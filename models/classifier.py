...
class model:
    ...
    def classement(data):
        ...
        class_names = loaded_model.classes_  # Obtener les noms de classe dans le bon ordre
        class_probabilities = list(proba[0])  # Convertir le tableau NumPy en une liste
